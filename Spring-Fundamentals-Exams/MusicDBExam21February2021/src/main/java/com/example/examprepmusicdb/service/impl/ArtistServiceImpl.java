...
import com.example.examprepmusicdb.repository.ArtistRepository;
...
public class ArtistServiceImpl implements ArtistService {
    ...
    @Override
    public Artist findByArtistName(ArtistNameEnum artistNameEnum) {
        return this.artistRepository.findByName(artistNameEnum).orElse(null);
    }
}
